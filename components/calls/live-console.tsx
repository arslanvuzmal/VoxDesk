  ...
  >([
    {
      role: 'AGENT',
      content:
        'Hello! Thank you for calling Northstar Legal Consultations. My name is Maya. How may I assist you today?',
      timestamp: '10:00:02',
    },
    {
      role: 'CALLER',
      content:
        "Hi Maya, I'm calling to book a legal consultation regarding a commercial contract dispute next Tuesday.",
      timestamp: '10:00:08',
    },
    {
      role: 'AGENT',
      content:
        'I can certainly help you schedule that consultation. May I confirm your full name and preferred email address for the calendar invite?',
      timestamp: '10:00:15',
    },
  ]);
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-xs text-[#8B949E] block">
              Agent: Maya • Northstar Legal Consultations
            </span>
          </div>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="p-2 rounded bg-[#171C22] border border-[#272D35] space-y-1">
              <p className="text-[11px]">
                <strong className="text-[#8B949E]">Service:</strong> Contract Litigation
              </p>
              <p className="text-[11px]">
                <strong className="text-[#8B949E]">Email:</strong> sa***@example.com
              </p>
              <p className="text-[11px]">
                <strong className="text-[#8B949E]">Requested Date:</strong> Next Tuesday (10:00 AM)
              </p>
            </div>
          </div>
        </div>
