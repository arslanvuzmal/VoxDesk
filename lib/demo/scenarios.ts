...
export const DEMO_SCENARIOS: DemoScenario[] = [
  {
    ...
    initialUtterance:
      "Hi, I need to book a legal consultation next Tuesday afternoon.",
  ...
  },
  {
    ...
    category: "booking",
    description:
      "Caller wants to move an existing appointment to a later date.",
  ...
  },
  {
    ...
    description:
      "High-budget commercial client seeking immediate legal representation.",
  ...
  },
  {
    ...
    category: "escalation",
    description:
      "Caller requests an immediate human transfer for urgent legal matter.",
    callerName: "Michael Chen",
    callerNumber: "+1 (555) 012-7788",
    initialUtterance:
      "I need to speak to a human lawyer right now. It is an urgent court notice.",
    expectedStateSequence: [
      "GREETING",
      "IDENTIFYING_INTENT",
      "ESCALATING",
  ...
  },
  {
    ...
    category: "story",
    description:
      "Comprehensive 10-step client journey demonstrating full platform capabilities.",
    callerName: "Sarah Miller",
    callerNumber: "+1 (555) 019-2834",
    initialUtterance:
      "Hi! I was referred to Northstar Legal for a contract consultation.",
    expectedStateSequence: [
      "GREETING",
      "IDENTIFYING_INTENT",
      "ANSWERING_QUESTION",
