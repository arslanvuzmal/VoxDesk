...
export const b2bServicesPreset: OrganizationProfile = {
  ...
  tagline: 'High-value inbound B2B sales qualification & enterprise demo scheduling',
  description:
  ...
  services: [
    {
      ...
      description: 'Cloud-native event-driven workflow engine with SOC2 & HIPAA compliance.',
    },
    {
    ...
    },
    {
      ...
      description: 'Dedicated TAMs, 99.99% uptime SLAs, and custom security review assistance.',
    },
  ],
  approvedKnowledge: [
    {
      ...
      keywords: ['pricing', 'tiers', 'cost', 'per user', 'enterprise tier', 'contract'],
    ...
    },
    {
      ...
      keywords: ['soc2', 'gdpr', 'hipaa', 'security', 'encryption', 'compliance', 'iso'],
      ...
      answer: {
        ...
        'ur-PK': 'جی ہاں! ہمارا پلیٹ فارم تصدیق شدہ SOC2 اور HIPAA معیار کی پاسداری کرتا ہے۔',
        'es-ES':
  ...
  complianceDisclaimer: {
    ...
    'ur-PK': 'توجہ فرمائیں: تمام نیکسس خدمات معیاری انٹرپرائز معاہدوں کے تحت دی جاتی ہیں۔',
    'es-ES':
    ...
    criteria: [
      {
        ...
        weight: 35,
        condition: 'Company size > 100 employees or annual software budget > $50,000.',
        scoringGuide:
      ...
      },
      {
        ...
        weight: 30,
        condition: 'Caller is VP Engineering, CTO, CIO, Chief Architect, or Operations Director.',
        scoringGuide: '30 pts for C-level/VP, 15 pts for Senior Engineering Manager.',
      },
      {
        ...
        scoringGuide: '20 pts for <60 day timeline, 10 pts for general evaluation.',
      },
      {
        id: 'crit-compliance-fit',
        name: 'Security & Feature Fit',
        weight: 15,
        condition: 'Requires standard cloud SaaS, SOC2 compliance, or existing API connector.',
  ...
  escalationTriggers: [
    {
      id: 'trig-fortune500',
      condition: 'Caller from Fortune 500 enterprise with >$100k ARR potential requesting VP Sales',
      reason:
