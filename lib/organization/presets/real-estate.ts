...
export const realEstatePreset: OrganizationProfile = {
  ...
  tagline: '24/7 Voice qualification for home buyers, sellers & listing enquiries',
  description:
  ...
  services: [
    {
      ...
      description: 'In-person or virtual guided property tours for qualified home buyers.',
    },
    {
      id: 'srv-home-valuation',
      name: 'Comparative Market Valuation & Home Listing',
      description: 'Professional market valuation and listing strategy for home sellers.',
    },
    {
      id: 'srv-property-mgmt',
      name: 'Property Management & Tenant Placement',
      description: 'Leasing, tenant screening, and maintenance management for property investors.',
    },
  ],
  approvedKnowledge: [
    {
      ...
      answer: {
        ...
        'ur-PK': 'ہماری کمیشن کی شرح 4% سے 5% تک ہے جس میں پیشہ ورانہ فوٹوگرافی شامل ہے۔',
        'es-ES':
    ...
    },
    {
      ...
      keywords: ['preapproval', 'mortgage', 'loan', 'financing', 'down payment', 'cash'],
    ...
    criteria: [
      {
        ...
        weight: 35,
        condition: 'Target home budget > $600,000 or seller property value > $750,000.',
        scoringGuide: '35 pts for high-tier price point, 20 pts for standard market average.',
      },
      {
        id: 'crit-preapproved',
        name: 'Financial Readiness',
        weight: 30,
        condition: 'Caller has active pre-approval letter or proof of liquid cash funds.',
        scoringGuide: '30 pts for verified pre-approval/cash, 15 pts for pending application.',
      },
      {
        ...
        scoringGuide: '20 pts for immediate <30 day timeline, 10 pts for 60-90 day horizon.',
      },
      {
        id: 'crit-representation',
        name: 'Unrepresented Status',
        weight: 15,
        condition: 'Not currently under exclusive buyer/seller representation contract.',
        scoringGuide: '15 pts for unrepresented lead ready for Vanguard agent agreement.',
      },
    ],
    scoreThresholds: {
      hot: 80,
  ...
  escalationTriggers: [
    {
      ...
      condition: 'Seller with property valued over $2,000,000 requesting immediate listing agent',
      reason: 'High-value luxury listing opportunity requires Senior Broker immediate callback',
      urgency: 'HIGH',
    },
  ],
