...
export const legalTrainingPack: BusinessTrainingPack = {
  ...
  services: [
    {
      ...
      category: 'Litigation',
      description: 'Contractual disputes, partner disagreements, and regulatory compliance.',
      durationMinutes: 45,
    ...
    },
    {
      ...
      category: 'IP Law',
      description: 'Trademark registration, patent enforcement, and copyright protection.',
      durationMinutes: 45,
      requiresConsultation: true,
    },
    {
      ...
      description: 'Wills, trusts, probate administration, and asset shielding.',
      durationMinutes: 45,
      requiresConsultation: true,
    },
  ],
  ...
  pricing: [
    {
      ...
      disclaimer: 'Formal retainer agreement required for ongoing legal representation.',
    },
  ],
  policies: [
    {
  ...
  faq: [
    {
      ...
      keywords: ['hours', 'open', 'time', 'office hours', 'schedule', 'location', 'address'],
    ...
    },
    {
      ...
      category: 'Hours & Location',
      keywords: ['location', 'address', 'where', 'office', 'located', 'suite', 'avenue'],
      question: 'Where is your office located?',
      answer: {
        'en-US': 'Our headquarters is located at 500 Fifth Avenue, Suite 2400, New York, NY 10110.',
        'ur-PK': 'ہمارا ہیڈ کوارٹر 500 ففتھ ایونیو، سویٹ 2400، نیویارک میں واقع ہے۔',
        'es-ES':
    ...
    },
    {
      ...
      keywords: ['fee', 'cost', 'price', 'charge', 'consultation fee', 'retainer', 'much'],
      ...
      answer: {
        ...
        'es-ES': 'La consulta inicial de estrategia cuesta $250 por hasta 45 minutos.',
      },
    ...
    },
    {
      ...
      category: 'Policies',
      keywords: ['cancel', 'reschedule', 'cancellation', 'change time', 'policy'],
      question: 'What is your cancellation policy?',
      answer: {
        'en-US':
          'You may reschedule or cancel your consultation without charge up to 24 hours prior to your scheduled time.',
        'ur-PK': 'آپ بغیر کسی چارج کے 24 گھنٹے پہلے تک ٹائم تبدیل یا منسوخ کر سکتے ہیں۔',
        'es-ES': 'Puede reprogramar o cancelar su consulta sin cargo hasta 24 horas antes.',
      },
    ...
    },
    {
      ...
      category: 'Services',
      keywords: ['corporate', 'litigation', 'business', 'contract', 'dispute', 'partner'],
      ...
      answer: {
        ...
        'ur-PK': 'جی ہاں، ہماری کارپوریٹ لٹیگیشن ٹیم کاروباری تنازعات سنبھالتی ہے۔',
        'es-ES':
    ...
    },
    {
      ...
      category: 'Services',
      keywords: ['patent', 'trademark', 'copyright', 'intellectual', 'ip', 'registration'],
      ...
      answer: {
        ...
        'es-ES': 'Sí, nos especializamos en registro de marcas comerciales y patentes.',
      },
    ...
    },
    {
      ...
      answer: {
        ...
        'es-ES': 'Sí, preparamos testamentos, fideicomisos y planes de protección de activos.',
      },
    ...
    },
    {
      ...
      category: 'Hours & Location',
      keywords: ['days', 'week', 'open', 'monday', 'friday', 'saturday', 'weekend'],
      ...
      answer: {
        ...
        'es-ES': 'Abrimos de lunes a viernes para consultas presenciales y virtuales.',
      },
    ...
    },
    {
      ...
      answer: {
        'en-US': 'Our physical office closes at 6:00 PM Eastern Time on Fridays.',
    ...
    },
    {
      ...
      category: 'Policies',
      keywords: ['conflict', 'interest', 'check', 'adverse', 'party', 'opposing'],
      ...
      answer: {
        ...
        'es-ES': 'Sí, realizamos una verificación obligatoria de conflicto de intereses.',
      },
    ...
    },
    {
      ...
      category: 'Intake',
      keywords: ['send', 'court', 'documents', 'email', 'mail', 'files', 'submit'],
      ...
      answer: {
        ...
        'es-ES': 'Puede enviar documentos judiciales a intake@northstarlegal.demo.',
      },
    ...
    },
    {
      ...
      answer: {
        ...
        'es-ES': 'Para emergencias judiciales, nuestro teléfono de guardia es +1 (800) 555-0199.',
      },
    ...
    },
    {
      ...
      category: 'Staff',
      keywords: ['partner', 'managing', 'attorney', 'on-call', 'director', 'who'],
      ...
      answer: {
        ...
        'es-ES': 'Nuestro socio director sénior de guardia supervisa las escalaciones urgentes.',
      },
    ...
    },
    {
      ...
      answer: {
        ...
        'es-ES': 'Las consultas se pueden agendar con hasta 14 días de anticipación.',
      },
    ...
    },
    {
      ...
      category: 'Services',
      keywords: ['small business', 'services', 'startup', 'corporate', 'agreements'],
      ...
      answer: {
        ...
        'es-ES': 'Brindamos constitución de empresas, contratos comerciales y defensa de litigios.',
      },
    ...
    },
    {
      ...
      answer: {
        ...
        'es-ES': 'Sí, puede reprogramar su consulta sin costo hasta 24 horas antes.',
      },
    ...
    },
    {
      ...
      category: 'Hours & Location',
      keywords: ['after-hours', 'night', 'weekend', 'voice', 'receptionist', '24/7'],
    ...
    criteria: [
      {
        ...
        weight: 30,
        condition: 'Caller demonstrates budget for commercial legal retainers (>=$5,000).',
        scoringGuide: '30 pts for commercial budget, 15 pts for standard, 0 for pro-bono only.',
      },
      {
        id: 'crit-commercial',
        name: 'Commercial / Case Substance',
        weight: 30,
        condition: 'Substantial business, IP dispute, or complex litigation contract.',
        scoringGuide: '30 pts for clear commercial dispute or corporate matter.',
      },
      {
        id: 'crit-timeline',
        name: 'Timeline & Court Deadlines',
        weight: 25,
        condition: 'Upcoming hearing or pending filing deadline within 14 days.',
        scoringGuide: '25 pts for urgent/active matter, 15 pts for planning within 30 days.',
      },
      {
        id: 'crit-authority',
        name: 'Decision Authority',
        weight: 15,
        condition: 'Caller is business owner, CEO, managing director, or executive.',
        scoringGuide: '15 pts for direct officer/owner, 10 pts for authorized employee.',
      },
    ],
    thresholds: {
      hot: 75,
  ...
  escalationPolicy: {
    ...
    triggers: [
      {
        id: 'trig-court-order',
        condition: 'Caller mentions active injunction, subpoena, or emergency court order today',
        reason: 'Immediate legal court deadline requires emergency attorney response',
        urgency: 'CRITICAL',
      },
      {
        id: 'trig-law-enforcement',
        condition: 'Caller mentions law enforcement search warrant or regulatory raid',
  ...
  restrictedTopics: [
    ...
    },
    {
      ...
      reason: 'Ethical rules forbid assisting in unlawful or fraudulent activity.',
      mandatoryRefusal: {
        'en-US':
          'Northstar Legal cannot provide advice on circumventing legal obligations or evading law enforcement.',
        'ur-PK': 'نارتھ اسٹار قانونی ذمہ داریوں سے بچنے کے بارے میں کوئی مشورہ نہیں دے سکتا۔',
        'es-ES':
...
export const legalPreset: OrganizationProfile = {
  ...
  appointmentSettings: {
    slotDurationMinutes: legalTrainingPack.appointmentPolicy.slotDurationMinutes,
