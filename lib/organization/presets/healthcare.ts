  ...
  services: [
    {
      ...
      description: 'Routine examinations, teeth cleaning, digital X-rays, and fluoride treatment.',
    },
    {
      id: 'srv-ortho',
    ...
    },
    {
      ...
      description: 'Annual wellness physicals, chronic condition checks, and minor illness care.',
    },
  ],
  approvedKnowledge: [
    {
    ...
    },
    {
      ...
      keywords: ['emergency', 'severe pain', 'swelling', 'toothache', 'bleeding', 'broken tooth'],
    ...
    criteria: [
      {
        ...
        weight: 35,
        condition: 'Active dental pain, broken crown, or acute symptom needing prompt care.',
        scoringGuide: '35 pts for acute pain/symptom, 20 pts for routine preventative care.',
      },
      {
        id: 'crit-insurance',
      ...
      },
      {
        ...
        weight: 20,
        condition: 'New family patient seeking full diagnostic exams & treatment plan.',
        scoringGuide: '20 pts for new comprehensive patient, 10 pts for existing follow-up.',
      },
      {
        id: 'crit-readiness',
        name: 'Appointment Slot Availability Fit',
        weight: 15,
        condition: 'Patient ready to confirm available appointment slot immediately.',
  ...
  escalationTriggers: [
    {
      ...
      condition: 'Patient reports facial swelling affecting throat, airway, or high fever',
      reason: 'Potential severe oral infection requiring immediate clinical intervention',
      urgency: 'CRITICAL',
    },
    {
      id: 'trig-life-threat',
      condition: 'Patient reports chest pain, difficulty breathing, or severe trauma',
