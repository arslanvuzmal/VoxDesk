...
export const homeServicesPreset: OrganizationProfile = {
  ...
  tagline:
    "Rapid emergency dispatch & automated service appointment scheduling",
  description:
    ...
    criteria: [
      {
        ...
        scoringGuide:
          "40 pts for active leak/emergency outage, 20 pts for standard repair.",
      },
      {
      ...
      },
      {
        ...
        weight: 15,
        condition:
          "Caller is the property owner authorized to approve repairs on site.",
        scoringGuide:
      ...
      },
      {
        ...
        weight: 15,
        condition:
          "Someone over 18 available at the property for technician arrival window.",
        scoringGuide:
          "15 pts for immediate technician arrival window confirmation.",
      },
    ],
    scoreThresholds: {
      hot: 70,
