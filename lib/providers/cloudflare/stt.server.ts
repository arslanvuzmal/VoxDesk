...
export async function transcribeAudioBufferWithCloudflare(
  ...
  try {
    ...
    throw new CloudflareAIError(
      error instanceof Error ? error.message : 'Failed to transcribe audio with Cloudflare Flux.',
