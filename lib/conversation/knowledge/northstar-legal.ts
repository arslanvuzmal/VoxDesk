...
export const NORTHSTAR_LEGAL_KNOWLEDGE: RoutineQA[] = [
  {
    keywords: ['hours', 'open', 'timing', 'schedule', 'when do you open', 'closing time'],
    answer:
  ...
  {
    keywords: ['location', 'address', 'where are you', 'office located', 'where is your office'],
    answer:
  ...
  {
    keywords: ['cancel', 'cancellation', 'reschedule policy', 'cancel appointment'],
    answer:
      'Appointments can be cancelled or rescheduled up to 2 hours before your start time with no penalty in our demo workflow.',
    suggestedAction: 'NONE',
  },
  {
    keywords: ['human', 'speak to a person', 'real person', 'operator', 'talk to human'],
    answer:
  ...
  {
    keywords: ['services', 'what do you do', 'practice areas', 'what kind of law'],
    answer:
