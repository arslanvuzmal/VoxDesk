      ...
      <div className="max-w-7xl mx-auto px-6 py-16 space-y-12">
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-sm">
            VoxDesk AI is built for strict multi-tenant isolation, AES-256
            encryption, HMAC signature verification, and zero credential
            leakage.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="glass-panel p-6 rounded-2xl border border-gray-800 space-y-4">
            ...
            <p className="text-xs text-gray-300 leading-relaxed">
              All stored telephony credentials, provider tokens, and customer
          ...
          <div className="glass-panel p-8 rounded-2xl border border-gray-800 space-y-4">
            ...
            <p className="text-xs text-gray-300 leading-relaxed">
              Every database query is enforced with a mandatory workspaceId
              scoping filter. RBAC permissions ensure cross-workspace data
              access is strictly prevented.
            </p>
          </div>
          ...
          <div className="glass-panel p-8 rounded-2xl border border-gray-800 space-y-4">
            ...
            <p className="text-xs text-gray-300 leading-relaxed">
              Telephony webhooks from Twilio, Vapi, and Retell undergo SHA-256
