...
export const metadata = {
  ...
  description:
    "Terms of Service and Usage Disclosures for VoxDesk Voice Operations Platform.",
};
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto p-6 py-12 space-y-8">
        ...
        <div className="p-4 rounded-lg bg-white border border-[#CBD5E1] text-xs space-y-2 text-[#334155] shadow-sm">
          ...
          <p className="leading-relaxed">
            VoxDesk is a voice operations software demonstration. Conversational content, consultation bookings, and lead scores generated by this system do not constitute binding legal representation or medical advice.
          </p>
        </div>
        ...
        <div className="space-y-6 text-xs text-[#334155] leading-relaxed">
          <section className="space-y-2 bg-white p-6 rounded-xl border border-[#E2E8F0] shadow-sm">
            ...
            <p>
              The public voice sandbox is provided for technology evaluation under operational session limits.
            </p>
          </section>
          ...
          <section className="space-y-2 bg-white p-6 rounded-xl border border-[#E2E8F0] shadow-sm">
            ...
            <p>
              VoxDesk and its underlying voice operations architecture are owned by Arslan Vuzmal Lone.
            </p>
          </section>
        </div>
      </main>
