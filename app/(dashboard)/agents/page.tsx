    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-400">Configure AI voice receptionists, prompts, greetings, and assigned calendars.</p>
        </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-xs font-mono text-gray-400">Provider: <strong className="text-teal-400">{a.provider}</strong></span>
                </div>
              </div>
