...
export default async function CallDetailPage(props: {
  ...
  const transcript = [
    {
      speaker: "agent",
      text: "Thank you for calling Northstar Legal Consultations. My name is Maya. How can I assist you today?",
    },
    {
      speaker: "caller",
    ...
    {
      speaker: "agent",
      text: "I'd be glad to help you schedule that! May I have your full name and email address?",
    },
    {
      speaker: "caller",
    ...
    {
      speaker: "agent",
      text: "Thank you Sarah. We have openings at 2:00 PM EST and 3:30 PM EST. Which works better?",
    },
    { speaker: "caller", text: "2:00 PM EST is perfect for me." },
    {
      speaker: "agent",
      text: "Confirmed! Your Legal Consultation is booked for Tuesday at 2:00 PM EST. A confirmation email has been dispatched.",
    },
  ];
      ...
      <div className="glass-panel p-6 rounded-2xl border border-gray-800 space-y-4">
        ...
        <div className="p-4 rounded-xl bg-gray-950 border border-gray-900 text-xs leading-relaxed space-y-2">
          <p className="text-gray-200">
            <strong>Summary:</strong> Caller Sarah Miller booked a legal
            consultation appointment for next Tuesday at 2:00 PM EST regarding
          ...
          <div className="flex flex-wrap gap-4 text-gray-400 pt-2 border-t border-gray-900">
            ...
            <span>
              Sentiment: <strong className="text-emerald-400">Positive</strong>
            </span>
            <span>
              Urgency: <strong className="text-teal-300">High</strong>
            </span>
            <span>
              Outcome:{" "}
          ...
          {transcript.map((t, idx) => (
            <div
              ...
              className={`p-4 rounded-xl text-sm border ${
                t.speaker === "agent"
                  ? "bg-teal-950/30 border-teal-900/50 text-teal-100 ml-6"
