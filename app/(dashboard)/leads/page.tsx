    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-400">
          Automated BANT / CHAMP lead scoring and qualification breakdowns.
        </p>
      </div>
            ...
            >
              <div>
                ...
                <p className="text-gray-400 mt-0.5">
                  Service: <strong className="text-white">{l.service}</strong> •
              ...
              <div className="flex items-center gap-3">
                <span
                  className={`px-3 py-1 rounded font-bold font-mono ${l.category === "HOT" ? "bg-emerald-950 text-emerald-400 border border-emerald-800" : "bg-teal-950 text-teal-300 border border-teal-800"}`}
                >
