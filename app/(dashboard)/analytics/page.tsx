    ...
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-white">
          Call Analytics & Provider Costs
        </h1>
        <p className="text-sm text-gray-400">
          Database-backed metrics, duration breakdowns, and provider cost
          estimates.
        </p>
      </div>
