    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-400">
          All calendar bookings created by AI voice receptionists.
        </p>
      </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 mt-0.5">
                    {a.service} •{" "}
                    <strong className="text-teal-300">{a.time}</strong>
                  </p>
                </div>
              </div>

              <div className="flex items-center gap-3">
                <span className="px-2.5 py-1 rounded bg-gray-900 border border-gray-800 text-gray-400 font-mono text-[11px]">
                  {a.provider}
                </span>
