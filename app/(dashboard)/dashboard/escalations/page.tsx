    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-400">
          Context-rich handoff briefings generated when callers request a human or trigger urgent
          keywords.
        </p>
      </div>
            ...
            <div key={e.id} className="p-5 rounded-xl bg-gray-950 border border-gray-900 space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-white">
                      {e.caller} <span className="text-xs text-gray-400">({e.number})</span>
                    </h4>
              ...
              <div className="p-3 rounded-lg bg-gray-900 text-xs text-gray-200 border border-gray-800">
                ...
                <p className="text-gray-400 mt-2 font-mono">
                  Recommended Action: Duty attorney to perform direct phone callback within 15
                  minutes.
                </p>
              </div>
            </div>
